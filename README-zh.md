[English](https://github.com/baoabaob/hexo-theme-oranges/blob/master/README.md) | 简体中文
...
```bash
git submodule add https://github.com/baoabaob/hexo-theme-oranges.git themes/oranges
```
